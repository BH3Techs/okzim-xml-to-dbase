...
public class PrintAllHandlerSax extends DefaultHandler {
   private static final String SQL_INSERT = "INSERT INTO ipay(TxGuid) VALUES(?)";
   private StringBuilder currentValue = new StringBuilder();
     ...
     public void startElement(String uri,String localName,String qName,Attributes attributes) {   
         ...
         if (qName.equalsIgnoreCase("MessageHeader")) {
             // get tag's attribute by name
             // String Opcode = attributes.getValue("PosId");
//              psInsert.setString(1, Opcode);
//              
//              String TicketAmount= attributes.getValue("StoreId");
//              psInsert.setString(2, Opcode);
//              
//              String TicketTotal= attributes.getValue("TicketNumber");
//              psInsert.setString(3,TicketTotal);
//              
//              String VoidTicket= attributes.getValue("CashierId");
//              psInsert.setString(4, VoidTicket);
             
             String SaveTicket= attributes.getValue("TxGuid");
             psInsert.setString(1, SaveTicket);
